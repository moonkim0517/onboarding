...
==================================================
# [온보딩 빠른 참조] PROPER MARKET 한눈에 보기
==================================================

이 섹션은 AI 온보딩 어시스턴트가 신입 디자이너의 질문에 빠르게 답하기 위한 우선 참조 요약입니다. 상세 근거는 아래 원문 문서들을 함께 참고합니다.
...
|---|---|
| 브랜드명 | PROPER MARKET |
| 현재 미션 | **Design better Life** — 더 나은 삶을 디자인 |
| 내부 뿌리 | 건강민주화 — 모두가 더 쉽게 건강을 챙기도록 돕는 것 |
| 브랜드 역할 | 오늘 하루를 기분 좋게 살아가는 선택을 돕는 곳 |
| 핵심 감각 | 누구보다 나를 잘 아는 세련되고 편안한 친구 |
| 디자인 키워드 | 자연스럽게, 쉽게, Something Different |

PROPER MARKET은 단순한 웰니스 커머스가 아니라, 더 나은 생활 방식을 제품·콘텐츠·경험으로 설계하는 브랜드입니다. 건강을 강요하기보다 "이 정도면 충분히 잘하고 있어요"라고 옆에서 말해주는 친구 같은 위치를 지향합니다.

## 2. 브랜드가 믿는 것

| 원칙 | 의미 |
|---|---|
| PROPER TASTE | 자극을 설계하지 않는 맛. 원물의 맛과 질감을 남긴다. |
| PROPER MADE | 더하기보다 기본에 집중하고, 먹는 사람에게 정직한 쪽으로 만든다. |
| What We Don't Use | 인공 향료, 인공 색소, 수크랄로스, 발색제, 유화제, 표백 밀가루, 인공 트랜스 지방처럼 속이거나 과하게 보정하는 요소를 피한다. |
| Easy Accuracy | 내부자 언어나 추상어가 아니라, 부모님도 이해할 수 있을 정도로 쉽게 정확하게 말한다. |
| One Process | 상품 기획, 디자인, 카피, 광고, 고객 인식은 분리되지 않고 하나의 연속체다. |

## 3. 고객과 시장 관점

| 관점 | 핵심 |
|---|---|
| 주요 고객 | 25~45세, 자신의 라이프스타일을 소비로 표현하는 사람들 |
| 고객 심리 | 외부 권위에 판단을 맡기지 않고 자기 기준으로 고르는 사람 |
| 구매 이유 | 스펙보다 감각. 특히 원물감, 알갱이, 진짜 같은 질감이 신뢰를 만든다. |
| 성장 엔진 | 광고보다 가족·지인 전파, 선물, 루틴 편입이 강하다. |
| 시장 목표 | CJ, 풀무원, 한살림과 같은 기존 카테고리 안에서 경쟁하지 않고 "PROPER MARKET"이라는 고유한 위치를 만든다. |

고객은 "단백질 몇 g"보다 "진짜 콩물의 알갱이", "오늘도 잘 챙겼다"는 감정, "제대로 고를 줄 아는 나"라는 정체성에 반응합니다. 따라서 디자인과 카피는 기능 설명에만 머물지 않고 감각·상황·루틴을 함께 설계해야 합니다.

## 4. 주요 제품과 프로젝트

| 제품/프로젝트 | 현재 의미 |
|---|---|
| 서리태콩물두유 | 서콩두의 핵심 제품군. 원물감과 신뢰를 대표하는 제품. |
| 소프트 프로틴 | 서리태콩물두유의 낮은 프로틴 함량을 보완한 식물성 고프로틴 제품. "운동하지 않아도 마실 수 있는, 달지 않은 식물성 프로틴 음료"로 포지셔닝. |
| LAZY SALAD | 구 매일 마시는 샐러드. "Not perfect, just enough"와 "귀찮은 날의 마시는 샐러드"를 중심으로 완벽하지 않은 사람들을 위한 웰니스를 말한다. |
| PROPER MADE | "제대로 만든다"는 철학을 브랜드 자산으로 만드는 서브 브랜드/인증 마크 시스템. 모든 것에 붙이는 로고가 아니라 기준을 통과한 것에만 선택적으로 적용한다. |
| PeacePower | 여행·이동 피로를 위한 "Quiet Energy" 프로젝트. 카페인과 당 중심 에너지 시장 사이의 빈틈을 노린다. |
| 안국역 Station 스토어 | Seoul Oasis 컨셉의 오프라인 거점. 외국인 관광객과 국내 여행객에게 브랜드를 경험시키는 허브. |

## 5. 디자인팀 업무 관점

| 영역 | 신입 디자이너가 알아야 할 것 |
|---|---|
| 핵심 OKR | O1 전환 UX, O2 마케팅 콘텐츠 운영, O3 신상품 런칭, O4 브랜드 시스템 구축 |
| 기본 흐름 | 요청시트 확인 → Figma 작업 → 피드백 → 배포 |
| 주요 툴 | Figma, Notion, Google Drive, Google Sheets |
| 이지솔님 역할 | UX/UI 70%, 마케팅·프로모션 디자인 20%, AI 기반 디자인 프로세스 10% |
| 첫 주 추천 행동 | 디자인 요청시트와 OKR을 읽고, 현재 프로젝트와 브랜드북의 핵심 언어를 먼저 파악한다. |
| 1.5개월 목표 | 팀 업무 파악 완료, 첫 독립 작업 완수 |
| 3개월 목표 | UX 개선 프로젝트 주도, 팀 내 디자이너로 자리잡기 |
...
| "효과가 증명되었습니다"처럼 과장된 단정 | "나와 비슷한 사람이 이렇게 먹어요" |
| 훈계, 강요, 내려다보는 말 | 편안한 친구처럼 허락하고 안심시키는 말 |
| 내부자만 아는 추상어 | 상황 중심의 쉬운 말 |

브랜드 전체 톤은 허락하는 친구에 가깝고, PROPER MADE는 확신 있는 기준에 가깝습니다. 둘 다 과장하거나 설득하려 들기보다, 차분하고 정확하게 말해야 합니다.

## 7. AI 검색 추천 질문

- PROPER MARKET은 어떤 브랜드야?
- Design better Life는 무슨 뜻이야?
- PROPER MADE는 왜 중요한가요?
- 서리태콩물두유와 소프트 프로틴의 차이는?
- LAZY SALAD는 어떤 톤으로 말해야 해?
- 디자인팀 OKR을 신입 디자이너 관점에서 정리해줘.
- 이지솔님이 첫 주에 먼저 봐야 할 문서는?
- PROPER MARKET다운 카피 예시를 만들어줘.
- 고객 인터뷰에서 가장 중요한 인사이트는?
- PeacePower와 안국역 Station 스토어는 어떤 프로젝트야?

## 8. 근무/복지 FAQ

| 질문 | 답변 |
|---|---|
| 점심시간은 언제부터 언제까지인가요? | 오전 11시 30분부터 12시 40분까지 총 1시간 10분입니다. 식대는 10,000원이 지급됩니다. |
| 연차는 어떻게 생기나요? | 연차는 한 달에 하나씩 생깁니다. |
| 생일 연차가 있나요? | 생일에는 반차를 지급합니다. |
| 병원을 가야 할 경우 출근 시간을 조정할 수 있나요? | 병원 방문이 필요한 경우 시차 출근이 가능합니다. 예: 오전 8시 출근, 오후 5시 퇴근. 단, 현규팀장에게 사전에 동의를 받아야 합니다. |
| 공식몰 임직원 혜택은 어떻게 받을 수 있나요? | 공식몰 회원 가입 후 CS팀에게 전달되면 임직원 등급 할인을 받을 수 있습니다. 할인율은 대략 34%입니다. 3개월 수습기간이 지나면 매달 10팩 쿠폰 2장이 지급됩니다. |
| 도서지원비가 있나요? | 수습 기간이 끝나면 매달 도서지원비를 받을 수 있습니다. |


==================================================
# [문서] PROPER MARKET_디자인팀_종합_인사이트
==================================================

# PROPER MARKET 디자인팀 종합 인사이트 (v3)
...
**PROPER MARKET은 더 이상 웰니스 커머스가 아니다. 더 나은 삶을 디자인하는 브랜드다.**
...
[반] 탈 브랜딩 / 안티 브랜딩
     기존 공식을 의도적으로 벗어남
     "브랜드처럼 보이는 것"이 아님. PROPER MARKET만의 방식으로 존재
...
PROPER MARKET의 성장은 광고→전환보다 **사람→사람** 전파에 더 강하게 의존한다.
...
대부분의 건강식품이 2단계(안전)에서 말하지만, PROPER MARKET 고객은 이미 4~5단계(존중·자아실현)를 체감. **안전 메시지에만 머물면 고객이 느끼는 가치보다 아래에서 말하게 된다.**
...
### 3.3. 이야기 자본 × PROPER MARKET

이야기 자본의 3가지 서사와 PROPER MARKET 현재 상태:

| 서사 유형      | 정의                         | PROPER MARKET 현재                                      |
| ---------- | -------------------------- | --------------------------------------------- |
...
> "제대로 만든다" — PROPER MARKET의 철학을 외부에 알리고, 브랜드 자산으로 만드는 서브 브랜드 / 인증 마크 시스템
...
미래: PROPER MARKET(기표) ───→ PROPER MADE(기의)
      "PROPER MARKET이라는 브랜드"    "제대로 만든다는 개념 자체"
```
...
| 큐레이션 제품 (장바구니 상품) | 🔄 기준 검토 후 | "PROPER MARKET이 검증한 제품" — Phase 2 |
...
PROPER MARKET에는 **"제대로 만든다"** 는 철학이 있다. 이 기준을 외부에 알리고, 브랜드 자산으로 만든다.

| # | 목적 | 설명 |
|---|------|------|
| 1 | **차별화** | 타 브랜드, 카피캣과 차별화되는 기준 필요 |
| 2 | **브랜드 자산** | "PROPER MARKET다움" 브랜드 자산 구축과 시각적 체계화 |
...
| 단계 | 대상 | 실행 |
|------|------|------|
| **여론 주도자** | 아티스트, 셰프, 크리에이터 | "제대로 만드는 사람들" 시리즈 — 이들의 철학을 먼저 보여준다. PROPER MARKET 제품 이야기가 아니라 **"제대로"라는 가치의 이야기** |
...
> [!tip] 04. 브랜드 일관성 우선
> PROPER MADE는 독립 브랜드가 아닌 PROPER MARKET의 **하위 체계**이다.
...
| **성분 투명성** | 첨가물 사용 기준, 전성분 공개 여부, 영양 정보 정확성 | PROPER MARKET의 "깨끗한 원료" 철학 반영 |
...
| [[PROPER MARKET_디자인팀_2026_OKR]] | 전체 OKR 구조 및 분기별 로드맵 |
...
> PROPER MARKET의 브랜드 정체성, 철학, 전략, 실행 원칙을 하나로 정리한 핵심 문서.
...
2025       '후유아' → 'PROPER MARKET' 리브랜딩 → 2025년 매출 140억원
...
> 정의: PROPER MARKET의 모든 부서가 PROPER MARKET 브랜드 경험의 기준으로 삼는 감각 앵커.
...
> 우리의 고객은 PROPER MARKET을 통해 자신의 **라이프스타일을 표현**한다. (주 연령: 25~45세)
...
PROPER MARKET은 **오늘 하루를 기분 좋게 살아가는 선택을 돕는 곳**.
...
| 원칙 | 기준 |
|------|------|
| PROPER MARKET다운가? | 이 선택은 'PROPER MARKET'다운가? |
...
- **CJ, 풀무원, 한살림이 아니다. "PROPER MARKET"이다.**
...
#브랜드북 #PROPER MARKET #BX #브랜딩전략 #웰니스 #포지셔닝 #바이블
...
> 디자인팀이 구축한 브랜드 가이드라인(`index.html`)을 대표의 관점에서 리뷰하고, 문서 자체에 PROPER MARKET의 보이스톤을 적용한 내역을 정리한 문서.
...
### 3.1 5 LAYERS (PROPER MARKET의 구조)
- **[초안]** Mission, Vision, Values — 이건 남이 만들어 놓은 틀이다. PROPER MARKET은 그 틀에 우리를 끼워 넣지 않는다. 대신, 우리는 이렇게 움직인다.
...
- **[초안]** 우리가 말하는 법, 말하지 않는 법. PROPER MARKET은 기업·회사처럼 말하지 않는다. 많이 설명하지 않는다. 취향과 선택처럼 보이게 한다.
...
**연결 문서**
- [[PROPER MARKET_디자인팀_2026_OKR]]
- [[PROPER MARKET Brand Book]]
- [[고객 입장 연구소]]


==================================================
# [문서] PROPER MARKET_디자인팀_2026_OKR_요약
==================================================
...
tags:
  ...
  - BX
  - UX
parent: "[[PROPER MARKET_디자인팀_2026_OKR_요약]]"
type: Objective
---
...
## 관련 문서
- [[PROPER MARKET_디자인팀_2026_OKR_요약|← OKR 요약으로 돌아가기]]
...
# O2. PROPER MARKET의 성장을 지원하는 마케팅 콘텐츠 제작 및 운영
...
# O4. PROPER MARKET 브랜드 아이덴티티 시스템 구축 (BI)
...
PROPER MARKET의 신제품. 기존 서리태콩물두유의 프로틴 한계(7g)를 보완하고, 기존 프로틴 음료 시장에 새로운 카테고리로 진입하는 제품. **2026년 5월 26일 런칭 예정.**
